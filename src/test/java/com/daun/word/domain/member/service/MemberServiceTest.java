...
class MemberServiceTest {
    ...
    public void SetUp() {
        ...
        memberService = new MemberService(tokenService, new FakeMemberRepository(), encoder, null);
    }
    ...
    void register_fail_exist_email() throws Exception {
        //given
        RegisterRequest request = new RegisterRequest(member().getEmail().getValue(), "iWantBeNew@9", "songTTubi", "W", new Tier(1));
        //when&&then
        assertThatThrownBy(() -> {
    ...
    void login() throws Exception {
        ...
        assertAll(
                ...
                () -> assertThat(response.getNickname()).isEqualTo(member().getName()),
